    ...
    while True:
        try:
            ...
            while True:
                try:
                    #代理版本
                    # ip = re.findall('http://(.*?):', config.get_proxy())[0]
                    # # print(ip)
                    # socks.setdefaultproxy(socks.SOCKS5, ip, 8888)
        ...
        # while True:
            ...
            if "90309999" in need:
                ...
                print("被检测到轨迹 -> , 当前ip为 {} ,回传为{}, 建议更换cookie参数".format(ip, spider_attack))
...
#     print(i)
#     socket_request_for_shopee_fit_all("afawf", 'shopee.sg', "/api/v4/search/search_items?by=sales&limit=60&match_id=11075459&newest=0")
#     input("next")